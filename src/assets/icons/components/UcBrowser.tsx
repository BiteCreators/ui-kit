...
const SvgUcBrowser = (
  ...
  >
    <path
      d={
        "M15.5 32c3.59 0 6.5-2.462 6.5-5.5S19.09 21 15.5 21 9 23.462 9 26.5s2.91 5.5 6.5 5.5"
      }
      fill={"#fff"}
      stroke={"#fff"}
      strokeLinecap={"round"}
    ...
    <path
      d={
        "M22.038 28.935c.58-1.005.91-2.171.91-3.415a6.848 6.848 0 0 0-12.594-3.726"
      }
      fill={"#fff"}
    />
    <path
    ...
    <path
      d={
        "M13.606 19.14c3.954-2.779 9.431-1.675 12.92 1.639 4.02-.707 5.478 1.767 5.478 1.767-1.71-.134-3.775.492-5.14 1.007a2.28 2.28 0 0 1-2.502-.592c-2.694-2.972-6.85-5.69-10.756-3.82"
      }
      fill={"#fff"}
      stroke={"#fff"}
      strokeLinecap={"round"}
